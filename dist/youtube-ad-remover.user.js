...
(()=>{"use strict";const e=[".ytp-ad-image-overlay","ytd-player-legacy-desktop-watch-ads-renderer","#masthead-ad","ytd-promoted-sparkles-web-renderer"],t=[".ytp-ad-skip-button"],r=["video.html5-main-video","video.video-stream html5-main-video"],n=()=>{const e=document.querySelector(".ytp-ad-player-overlay");null!==e&&(e.setAttribute("style","\n      width: 100%;\n      height: 100%;\n      background: black;\n      position: absolute;\n      top: 0;\n      display: flex;\n      flex-direction: row;\n      align-items: center;\n      justify-content: center;\n      left: 0;\n      z-index: 10;\n    "),e.innerHTML="<div>Unskippable advertisement.</div>",r.forEach((e=>{document.querySelector(e).volume=0})))},o=()=>{t.forEach((e=>{document.querySelectorAll(e).forEach((e=>{e.click()}))}))};setInterval((()=>{e.forEach((e=>{document.querySelectorAll(e).forEach((e=>{(e=>{try{e.parentElement.removeChild(e)}catch(e){console.error(e)}})(e)}))})),document.querySelectorAll("ytd-rich-item-renderer:not(.hided)").forEach((e=>{e.querySelector(".badge-style-type-ad")&&(e.style.display="none",e.classList.add("hided"))}))}),400),setInterval(o,400),setInterval(n,400)})();